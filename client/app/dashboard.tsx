...
function TicketCard({ ticket, getUrgencyColor, autoExpand, onTicketUpdated, apiUrl }: { ticket: Ticket, getUrgencyColor: (u?: string) => string, autoExpand?: boolean, onTicketUpdated: (t: Ticket) => void, apiUrl: string }) {
